...
<<<<<<< HEAD
		headerImage: "sampleImage2" as keyof typeof IMAGES, // Adjust image as necessary
=======
...
<<<<<<< HEAD
		...
		headerImage: "provider" as keyof typeof IMAGES, // Adjust image as necessary
=======
		title: "How to Join the Tilla Health Network?",
...
<<<<<<< HEAD
		headerImage: "sampleImage5" as keyof typeof IMAGES, // Adjust image as necessary
=======
...
<<<<<<< HEAD
		headerImage: "sampleImage3" as keyof typeof IMAGES, // Adjust image as necessary
=======
...
>>>>>>> 68501ca (Initial commit)
		...
		features: [
			...
			},
			{
				...
				features: [
<<<<<<< HEAD
					"The Tilla Health Provider Web Portal serves as a quality control tool, allowing providers to view and manage their information within our system. Your provider details are shared with Tilla Health members and the provider community via our 'Find a Provider' website.",
=======
...
>>>>>>> 68501ca (Initial commit)
			...
			},
			{
				...
				features: [
<<<<<<< HEAD
					"Visit the Tilla Health Provider Web Portal at <a href='http://portal.link' className='text-blue-500 underline'>portal link</a> to register.",
=======
...
<<<<<<< HEAD
		headerImage: "broker" as keyof typeof IMAGES, // Adjust image as necessary
=======
...
<<<<<<< HEAD
		headerImage: "sampleImage3" as keyof typeof IMAGES, // Adjust image as necessary
		introduction:
			"Partnering with Tilla Health brings numerous benefits to enhance your offerings.",
=======
...
<<<<<<< HEAD
		whyChoosePoints: [],
		howToGetStarted: {
			title: "Getting Started with Tilla Health",
			steps: [
				"Contact our Provider Relations team to discuss partnership opportunities.",
				"Review and complete the necessary documentation.",
				"Attend an onboarding session to understand our offerings and tools.",
				"Start offering Tilla Health plans to your clients.",
=======
		whyChoosePoints: [
...
<<<<<<< HEAD
				...
				features: [
					...
					"Feel free to reach out for assistance or explore our resources to help you succeed.",
=======
