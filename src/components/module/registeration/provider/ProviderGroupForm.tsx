				...
				<fieldset className="border p-4 rounded-md bg-background">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									<FormLabel>{t("fields.provider_group_name.label")}</FormLabel>
									<FormControl>
										<Input
											placeholder={t("fields.provider_group_name.placeholder")}
											{...field}
											type="text"
										/>
									</FormControl>
									<FormMessage />
									<FormDescription>
										{t("fields.provider_group_name.description")}
									</FormDescription>
								</FormItem>
							)}
						/>
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									<FormLabel>
										{t("fields.provider_group_contact_person.label")}
									</FormLabel>
									<FormControl>
										<Input
											placeholder={t(
												"fields.provider_group_contact_person.placeholder"
											)}
											{...field}
											type="text"
										/>
									...
									<FormMessage />
									<FormDescription>
										{t("fields.provider_group_contact_person.description")}
									</FormDescription>
								</FormItem>
							)}
						/>
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									<FormLabel>
										{t("fields.provider_group_phone_number.label")}
									</FormLabel>
									<FormControl>
										<Input
											placeholder={t(
												"fields.provider_group_phone_number.placeholder"
											)}
											{...field}
											type="text"
										/>
									...
									<FormMessage />
									<FormDescription>
										{t("fields.provider_group_phone_number.description")}
									</FormDescription>
								</FormItem>
							)}
						/>
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									<FormLabel>
										{t("fields.provider_group_contact_email.label")}
									</FormLabel>
									<FormControl>
										<Input
											placeholder={t(
												"fields.provider_group_contact_email.placeholder"
											)}
											{...field}
											type="email"
										/>
									...
									<FormMessage />
									<FormDescription>
										{t("fields.provider_group_contact_email.description")}
									</FormDescription>
								</FormItem>
							)}
						/>
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									<FormLabel>
										{t("fields.provider_group_address.label")}
									</FormLabel>
									<FormControl>
										<Input
											placeholder={t(
												"fields.provider_group_address.placeholder"
											)}
											{...field}
											type="text"
										/>
									...
									<FormMessage />
									<FormDescription>
										{t("fields.provider_group_address.description")}
									</FormDescription>
								</FormItem>
							)}
						/>
